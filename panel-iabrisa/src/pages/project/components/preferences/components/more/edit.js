...
export default function EditMenuComponent(props) {
  const { handleCloseDialog, project, setProject, menu } = props;
  ...
  return (
    <Dialog fullWidth fullScreen={downMd} onClose={handleClose} open>
      <DialogContent>
        <form noValidate method="post" style={{ height: '100%' }}>
          <FlexBox alignItems="center" justifyContent="space-between">
            <Box>
              <H3 fontWeight={600}>Editar navegação</H3>
            </Box>
